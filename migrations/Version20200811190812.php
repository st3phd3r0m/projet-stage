 ...
 */
final class Version20200811190812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comments (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, pseudo VARCHAR(100) NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, is_moderated TINYINT(1) NOT NULL, INDEX IDX_5F9E962A4584665A (product_id), FULLTEXT INDEX IDX_5F9E962A86CC499DFEC530A9 (pseudo, content), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone VARCHAR(20) NOT NULL, subject VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, sent_at DATETIME NOT NULL, INDEX IDX_DB021E964584665A (product_id), FULLTEXT INDEX IDX_DB021E965E237E06E7927C74444F97DDFBCE3E7AB6BD307F (name, email, phone, subject, message), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pages (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, image JSON DEFAULT NULL, keywords JSON DEFAULT NULL, meta_tag_title VARCHAR(255) DEFAULT NULL, meta_tag_description LONGTEXT DEFAULT NULL, meta_tag_keywords JSON DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2074E575989D9B62 (slug), INDEX IDX_2074E575A76ED395 (user_id), FULLTEXT INDEX IDX_2074E5752B36786BFEC530A9E89AB48D154833C7 (title, content, meta_tag_title, meta_tag_description), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, language_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, hangout_location VARCHAR(255) NOT NULL, keywords JSON DEFAULT NULL, meta_tag_title VARCHAR(255) DEFAULT NULL, meta_tag_description LONGTEXT DEFAULT NULL, meta_tag_keywords JSON DEFAULT NULL, reference VARCHAR(8) NOT NULL, weezeevent VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, pre_tax_price NUMERIC(10, 2) DEFAULT NULL, tax_included_price NUMERIC(10, 2) DEFAULT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_B3BA5A5A989D9B62 (slug), INDEX IDX_B3BA5A5A82F1BAF4 (language_id), FULLTEXT INDEX IDX_B3BA5A5A2B36786BE89AB48D6DE44026154833C7 (title, meta_tag_title, description, meta_tag_description), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
